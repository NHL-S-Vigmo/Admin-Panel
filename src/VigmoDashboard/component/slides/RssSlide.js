...
export default class RssSlide extends React.Component {
    ...
    rssParser() {
        return {
            "title": "'Vriendin Dave De K. verdacht van moord in zaak rond dood 4-jarige Mark van der Hart waar je niet meer mee mag spotten want anders kom je in de pruttelpot'",
        ...
        return (
            <div className="slideContent" style={{padding: 0}}>
                <div className="rssjemoeder">
                    ...
                    <div className="rssDescriptionWrapper" dangerouslySetInnerHTML={{__html: this.rssParser().description}} />
                </div>
            </div>
        );
    }
